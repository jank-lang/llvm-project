...
// Regression test: registerFrameInfo must skip .pdata sections that have no
// blocks (e.g. COMDAT sections dead-stripped during pruning). Previously,
// these produced allocActions with a null .pdata pointer, causing a crash
// during finalization when the pointer was dereferenced.
